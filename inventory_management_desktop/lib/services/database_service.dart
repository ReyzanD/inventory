...
class DatabaseService {
  ...
  Future<void> insertProduct(Product product) async {
    ...
    await db.transaction((txn) async {
      // Insert product
      await txn.insert(tableProducts, product.toMap());
  ...
  Future<void> updateProduct(Product product) async {
    ...
    await db.transaction((txn) async {
      ...
      // Update product
      await txn.update(tableProducts, product.toMap(),
  ...
  Future<Product?> getProductById(String id) async {
    ...
    return Product(
      ...
      sellingPrice: maps.first['sellingPrice'],
      components: components,
      dateCreated: DateTime.fromMillisecondsSinceEpoch(maps.first['dateCreated']),
